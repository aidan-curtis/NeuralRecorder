...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *Phi, const
  char_T *identifier, emxArray_real_T *y);
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, emxArray_real_T *y);
static void e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret);
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *input_signal,
  ...
  char_T *identifier, emxArray_real_T *y)
{
  ...
  d_emlrt_marshallIn(sp, emlrtAlias(Phi), &thisId, y);
  ...
  const char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(input_signal), &thisId, y);
...
void Compress_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                  *plhs[1])
{
  ...
  emxInit_real_T(&st, &Phi, 2, true);
  emxInit_real_T(&st, &y, 1, true);

  /* Marshall function inputs */
  input_signal->canFreeData = false;
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "input_signal", input_signal);
  Phi->canFreeData = false;
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "Phi", Phi);
...
void Compress_atexit(void)
{
  ...
  Compress_xil_terminate();
}

void Compress_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Compress_api.c) */
